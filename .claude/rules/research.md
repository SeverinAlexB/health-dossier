...
- **research/**: "What does the science say about X?" — PubMed reviews, practitioner
  protocol analyses, mechanism deep dives, Reddit/Twitter experience compilations.
  Would be useful even for a different patient.
- **2_assessments/**: "What does X mean for THIS patient?" — Interprets patient's
  specific lab results, genetics, symptoms, or history.

## Structure

Organize by topic: `research/sibo/`, `research/thiamine/`, etc.
Put Reddit/Twitter compilations in a `reddit/` subfolder within the topic.
